...
<body>
	<div class="container">
		<div class="well well-lg">
			<?php if(!empty($horarios)){
				foreach($horarios as $Codigo){
					echo '<div align="center">';
					echo '<a href = "/editar/EditHorarioFund/'.$Codigo->codigoTurma.'" <button class = "btn btn-primary" style = "margin: 1%;" id="printPageButton">Editar horário</button></a>'; echo '<a href = "/deletar/deleteHorarioFundamental/'.$Codigo->codigoTurma.'" <button class = "btn btn-danger" onclick="return apagarMensagem()" id="printPageButton">Apagar</button></a>';
					echo '</div>';
				}
			} 
			?>
	...
	<script type="text/javascript">
		...
		function apagarMensagem(){
			...
			var r = confirm("Você deseja realmente excluir o horário desta turma?");
