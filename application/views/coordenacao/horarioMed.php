		...
		<div class="well well-lg">
			<?php if(!empty($horarios)){
				foreach($horarios as $Codigo){
					...
					echo '<a href = "/editar/EditHorarioMed/'.$Codigo->codigoTurma.'" <button class = "btn btn-primary" style = "margin: 1%;"  id="printPageButton">Editar horário</button></a>'; echo '<a href = "/deletar/deleteHorarioMedio/'.$Codigo->codigoTurma.'" <button class = "btn btn-danger" onclick="return apagarMensagem()"  id="printPageButton">Apagar</button></a>';
					echo '</div>';
				}
