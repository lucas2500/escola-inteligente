...
<head>
	...
	<title>Portal da coordenação</title>
...
<body>
	...
	<hr />
	<form action="<?php echo base_url();?>principal/menuCoordenacao" method="post">
		<div class="imgcontainer">
			<img src="<?php echo base_url('assets/img/img_avatar3.png');?>" alt="Avatar" class="avatar">
		</div>
		<div class="container">
			...
			<a href="<?php echo base_url();?>principal/menuCoordenacao"><button type="submit" class="button2">Entrar</button></a>
		</div>
	</form>
	<hr />
	<div  class="container">
