	...
	<div class="container"> 
		<div class="well well-lg">
			...
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#manha">Médio - manhã</a></li>
				<li><a data-toggle="tab" href="#tarde">Médio - tarde</a></li>
			</ul>
	...
	<div class="modal fade" id="formarTurma" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="<?php echo base_url();?>cadastro_turmas/salvarTurmaMed" method="post">
	...
	<div id="cadAluno" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="<?php echo base_url();?>cadastro/alocarAlunoMed" method="post">
					<div class="modal-body">
						<div class="input-group">
