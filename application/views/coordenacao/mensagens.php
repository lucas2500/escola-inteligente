...
<body>
	<div class="container">
		<div class="well well-lg">
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					foreach ($mensagens as $MENSAGEM){
						echo '<tr>';
						echo '<td style ="text-transform: uppercase;">'.$MENSAGEM->usuario.'</td>'; 
						echo '<td>'.$MENSAGEM->mensagem.'</td>'; 
						echo '<td>'.$MENSAGEM->dataEnvio.'</td>';
						echo  '<td><a href = "/deletar/deleteMSG/'.$MENSAGEM->ID.'"<button class="btn btn-danger" onclick="return apagarMensagem()"><span class="glyphicon glyphicon-trash"></span></button></a>';  
						echo '</td>'; 
						echo '</tr>';
					}
					?>
			...
			<br />
			<form action="<?php echo base_url();?>cadastro/enviarMSG" method="post">
				<div class="text-left">
					...
					<table class="table table-bordered" id="fundTarde">
						...
						<tbody>
							...
							foreach ($funcionarios as $FUNCIONARIOS){
								echo '<tr>';
								echo '<td style ="text-transform: uppercase;">'.$FUNCIONARIOS->nome.'</td>'; 
								echo '<td>'.$FUNCIONARIOS->MATRICULA.'</td>'; 
								echo '</tr>';
							}
							?>
						</tbody>	
