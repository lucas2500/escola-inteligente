	...
	<nav class="navbar navbar-inverse"  style="background-color: #083CE4; border-color: #083CE4;">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="<?php echo base_url();?>principal/navegarMenuCoord" style="font-family: times; font-size: 20px; color: white;">Menu principal</a>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<hr />
					<div align="right">
						<button type="button" class="btn btn-primary" onclick="gerarMat()">Gerar matrícula</button>
					</div>
					<br />
					<div class="form-group" align="center">
						<form name="meuForme" action="<?php echo base_url();?>cadastro/novosUsers" method="post">
							<div class="input-group">
								<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
								<input type="text" placeholder="NOME" class="form-control" name="nome"  id="name" required>
							</div>
							<br />
							<div class="input-group">
								<span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
							...
							<div class="input-group">
								...
								<input type="text" placeholder="MATRÍCULA" class="form-control" name="matricula"  id="MAT" required readonly>
							</div>
							<input type="hidden" placeholder="SENHA" class="field" name="senha" id="senha1" value="123456" required readonly>
							<button type="submit" onclick="return validateForm2()" class="button">Cadastrar</button>
						</form>
					</div>
				</div>
			</div>
